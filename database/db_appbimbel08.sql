...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2019 at 03:38 AM
...
(1, '002', 'tes 1', 'Arsip', '2019-10-30 04:07:19'),
(2, '003', 'tes kritik saran', 'arsip', '2019-10-30 04:12:33'),
(3, '001', 'tes kritik saran', 'New', '2019-10-30 04:13:50'),
(4, 'RG00001', 'tes kritik saran', 'New', '2019-10-29 15:05:22'),
(5, 'RG00004', 'tes kritik saran 4', 'New', '2019-10-29 15:16:04'),
(6, 'RG00004', 'tes kritik saran 4', 'New', '2019-10-29 15:20:42'),
(7, 'RG00005', 'tes kritik saran 5', 'New', '2019-10-29 15:21:44'),
(8, 'RG000003', 'ASASA', 'New', '2019-10-29 15:26:58'),
(9, 'RG000003', 'ASASA', 'New', '2019-10-29 15:27:11'),
(10, 'rg000009', 'tes data 09', 'New', '2019-10-29 15:29:25'),
(11, 'rg000009', 'tes data 09', 'New', '2019-10-29 15:29:36'),
(14, 'tes', 'tes', '', '2019-10-30 02:55:13'),
(15, 'tes id', 'tes isi', 'New', '2019-10-30 04:14:52'),
(16, '004', 'tes isi 004', 'New', '2019-10-30 04:36:31'),
(17, '004', 'tes isi 004', 'New', '2019-10-30 04:37:13'),
(18, '005', 'tes kritik saran 005', 'New', '2019-11-01 02:17:45'),
(19, '001', 'tes kritik saran 002', 'New', '2019-11-01 15:28:33'),
(20, '\'009\'', '\'tes kritik\'', 'New', '2019-11-01 15:43:04'),
(21, '\'009\'', '\'tes kritik\'', 'New', '2019-11-02 04:32:16'),
(22, '\'009\'', '\'tes kritik\'', 'New', '2019-11-03 03:59:05');
...
('5da60', 'asasa', 'd47e89b335ee1e869d3d5ddfcc6224aa', '002'),
('5ds', 'riankeren', '503b083ba20dd7f6e53ae576331e277f', '002'),
...
('5da5eece9c634', 'RC19000028', 'matematika (SD)', 'SD', '1-3');
...
CREATE TABLE `detailjadwal` (
  `idUnix` varchar(20) NOT NULL,
  `kodeDetailKursus_detailKursus` varchar(11) NOT NULL,
...
INSERT INTO `detailjadwal` (`idUnix`, `kodeDetailKursus_detailKursus`, `kodeKursus`, `idBidangStudi_bidangStudi`, `idTentor_detailKursus`, `idSiswa_appKursus`, `hari`, `jam`, `tglKursus`, `tglinsert`) VALUES
('5d98d1aeabc59', 'DK19000012', 'KB19000016', 4, '002', '003', 'Minggu', '09:30', '0000-00-00', '2019-10-06 05:09:32'),
('5d9c35ad6feca', 'DK19000016', 'KB19000016', 6, '002', '003', 'Sabtu', '10:00', '0000-00-00', '2019-10-08 07:07:25'),
('5d9c36447d052', 'DK19000017', 'KB19000017', 2, '001', '004', 'Kamis', '05:15', '0000-00-00', '2019-10-08 07:09:56'),
('5d9c368bbd3f6', 'DK19000018', 'KB19000016', 4, '001', '003', 'Sabtu', '05:15', '0000-00-00', '2019-10-08 07:11:07'),
('5d9c370cbba18', 'DK19000019', 'KB19000009', 6, '002', 'RG19000001', 'Rabu', '17:00', '0000-00-00', '2019-10-08 07:13:16'),
('5d9c37469909d', 'DK19000020', 'KB19000009', 6, '002', 'RG19000001', 'Kamis', '15:00', '0000-00-00', '2019-10-08 07:14:14'),
('5d9c37c700c74', 'DK19000021', 'KB19000017', 2, '002', '004', 'Minggu', '04:45', '0000-00-00', '2019-10-08 07:16:23'),
('5da49f831317b', 'DK19000023', 'KB19000019', 2, '002', '006', 'Selasa', '06:30', '0000-00-00', '2019-10-14 16:17:07');
...
CREATE TABLE `detailkursus` (
  `idUnix` varchar(20) NOT NULL,
  `kodeDetailKursus` varchar(11) NOT NULL,
...
INSERT INTO `detailkursus` (`idUnix`, `kodeDetailKursus`, `subTotal`, `kodeKursus`, `idBidangStudi`, `jumlahSesi`, `perSesi`, `idTentor`, `tglKursus`, `waktuKursus`, `durasiKursus`, `statusKursus`, `pertemuanKe`, `tglSelesai`, `KETERANGANTRANSAKSI`, `keteranganKursus`, `roleAbsen`) VALUES
('5d715b6', '', 240000, 'KB19000015', 2, 4, 60000, '002', '0000-00-00', '', 90, 'tidak aktif', 0, '0000-00-00', '', '', 0),
('5d715cd1ea3a8', 'DK19000012', 275000, 'KB19000016', 4, 5, 55000, '002', '0000-00-00', '', 90, '', 0, '0000-00-00', '', '', 0),
('5d715cd208664', 'DK19000002', 385000, 'KB19000016', 6, 7, 55000, '001', '0000-00-00', '', 0, 'aktif', 0, '0000-00-00', '', '', 1),
('5d715ddc3bb96', '', 420000, 'KB19000017', 5, 7, 60000, '001', '0000-00-00', '', 0, 'aktif', 0, '0000-00-00', '', '', 0),
('5d715ddc3cb37', '', 360000, 'KB19000017', 2, 6, 60000, '002', '0000-00-00', '', 0, '', 0, '0000-00-00', '', '', 0),
('5d715e76f0d71', '', 420000, 'KB19000019', 2, 7, 60000, '001', '0000-00-00', '', 90, 'aktif', 0, '0000-00-00', '', '', 0),
('5d7160bc6d8e3', '', 250000, 'KB19000020', 1, 5, 50000, '', '0000-00-00', '', 0, 'mendaftar', 0, '0000-00-00', '', '', 0),
('5d71611062c3d', '', 420000, 'KB19000021', 3, 6, 70000, '', '0000-00-00', '', 0, '', 0, '0000-00-00', '', '', 0),
('5d716551acd05', '', 360000, '0002', 2, 6, 60000, '', '0000-00-00', '', 90, 'aktif', 0, '0000-00-00', '', '', 0),
('5d75d25987551', '', 240000, '0001', 2, 4, 60000, '', '0000-00-00', '', 90, 'aktif', 0, '0000-00-00', '', '', 0),
('5d75d48a437a9', '', 300000, 'KB19000028', 1, 6, 50000, '-', '0000-00-00', '-', 90, 'mendaftar', 0, '0000-00-00', '', '', 0),
('5d8b7388d7ee9', '', 220000, 'KB19000009', 6, 4, 55000, '-', '0000-00-00', '-', 90, 'mendaftar', 0, '0000-00-00', '', '', 0),
('5d8b780661b4e', '', 330000, 'KB19000010', 4, 6, 55000, '-', '0000-00-00', '-', 90, 'tuntas', 0, '0000-00-00', '-', '-', 0),
('5d8b78fe63f2f', '', 560000, 'KB19000011', 3, 8, 70000, '-', '0000-00-00', '-', 90, 'mendaftar', 0, '0000-00-00', 'Belum ', '-', 0),
('5d8b795d78906', '', 540000, 'KB19000012', 2, 9, 60000, '002', '0000-00-00', '-', 90, 'aktif', 0, '0000-00-00', 'Belum Dibayar', '-', 0),
('5d8b82411f00c', '', 350000, 'KB19000013', 1, 7, 50000, '001', '0000-00-00', '-', 90, 'aktif', 0, '0000-00-00', 'Belum Dibayar', '-', 0);
...
CREATE TABLE `detailpembayaran` (
  ...
  `noPembayaran` varchar(11) NOT NULL,
...
INSERT INTO `detailpembayaran` (`idUnixs`, `noPembayaran`, `kodeKursus_app_kursus`, `namaSiswa`, `jumlahBayar`, `metodebayar`, `noRek`, `tglBayar`) VALUES
...
('5d9d506', '', 'KB19000012', 'Wilda', 540000, 'TF', '215423255', '2019-10-09 03:13:49');
...
CREATE TABLE `detailpenggajian` (
  `idUnixs` varchar(7) NOT NULL,
  `noPenggajian` varchar(11) NOT NULL,
  `kodeKursus_detailKursus` varchar(11) NOT NULL,
  `idTentor_detailKursus` varchar(11) NOT NULL,
  `idSiswa_detailKursus` varchar(11) NOT NULL,
  `idBidang_detailKursus` int(10) NOT NULL,
  `jumlahGaji` float NOT NULL,
  `jumlahBonus` float NOT NULL,
  `metodeBayar` varchar(7) NOT NULL,
  `noRek` varchar(20) NOT NULL,
  `noTentor` varchar(12) NOT NULL,
  `tglBayar` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `detailpenggajian` (`idUnixs`, `noPenggajian`, `kodeKursus_detailKursus`, `idTentor_detailKursus`, `idSiswa_detailKursus`, `idBidang_detailKursus`, `jumlahGaji`, `jumlahBonus`, `metodeBayar`, `noRek`, `noTentor`, `tglBayar`) VALUES
('5d9f467', 'NP19000023', 'KB19000016', '002', '003', 6, 150000, 25000, 'TF', '236545875689', '023105640987', '2019-11-03 03:59:39'),
('5d9f469', 'NP19000024', 'KB19000016', '002', '003', 6, 98000, 0, 'CASH', '-', '023105640987', '2019-11-03 03:59:39'),
('5d9f46c', 'NP19000025', 'KB19000017', '002', '004', 5, 450000, 15200, 'CASH', '-', '023105640987', '2019-11-03 03:59:39');
...
CREATE TABLE `tb_customer` (
  ...
  `ALAMATCUSTOMER` text,
  `NEGARA` int(3) NOT NULL,
  `PROVINSI` int(2) NOT NULL,
  `KABUPATEN` int(4) NOT NULL,
  `KODEPOSCUSTOMER` varchar(5) DEFAULT NULL,
  `NPWP` varchar(45) NOT NULL,
  `KTP` varchar(39) NOT NULL,
...
INSERT INTO `tb_customer` (`IDCUSTOMER`, `NAMACUSTOMER`, `ALAMATCUSTOMER`, `NEGARA`, `PROVINSI`, `KABUPATEN`, `KODEPOSCUSTOMER`, `NPWP`, `KTP`, `EMAIL`, `NOTLP`, `NOHP`, `JABATAN`, `STATUS`, `NOREK`) VALUES
(25, 'PT SEJAHTERA', 'jl permata hijau PARIT 18', 1, 51, 5171, '98789', '999.888.999.777.666', '2.222.222.222', 'SEJAHTERA@gmail.com', '09876987987', '12345678912', 'staf accounting', '10%', '999999999999999'),
(27, 'andi', 'sdfdfd', 2, 33, 3276, '23232', '', '', '', '234243', '23434', 'as', '', '23242343243');
...
(1, '1_agreement', '1-agreement.png', 1),
(2, '2_certificate', '2-certificate.png', 1),
...
(12, '8 tes data ', '8-tes-data-.png', 1);
...
(1, 'Akhlak terhadap ilmu', 'Disiplin'),
...
CREATE TABLE `tb_kuis` (
  ...
  `idIcons` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tb_kuis` (`id_kuis`, `tb_kategori_kuis_id_kategori_kuis`, `namaKuis`, `keterangan`, `idIcons`) VALUES
...
(14, 1, 'MERDEKA', 'tes merdeka', '3'),
(15, 1, 'MERDEKA 01', 'merdeka 01', '5');
...
(6, 'Tess yang kedua', '>500 kata', '2019-10-31', '2019-10-14 05:50:00');
...
(14, 8, 'Gaji Tentor', '', 'master/Con_penggajianTentor', 'data-gaji-tentor', 0),
...
(22, 33, 'Data User Login', '', 'master/Users', 'data-user-login', 0),
...
(35, 32, 'Riwayat Penggajian', '', 'master/Con_riwayatPenggajian', 'riwayat-penggajian-tentor', 0),
(36, 17, 'Set Indikator Nilai', '', 'settings/Con_indikatorNilai', 'data-indikator-nilai', 0),
(37, 31, 'Penjadwalan', '', 'settings/Con_JadwalKursus', 'penjadwalan-kursus', 0),
(38, 17, 'Set Icon Kuis', '', 'master/SetIcons', 'data-set-icons-for-setkuis', 0);
...
INSERT INTO `tb_pengguna` (`penggunaId`, `tb_role_roleId`, `app_rate_idapp_rate`, `tb_kategori_kategoriId`, `namaDepan`, `nomorKtp`, `namaBelakang`, `alamat`, `tempatTinggal`, `tempatLahir`, `tglLahir`, `umur`, `email`, `noWa`, `foto`, `pendidikanTerakir`, `pengalamanMengjar`, `guruMapel`, `status`, `pendidikanSekarang`, `rattings`, `namaBank`, `noRek`) VALUES
('001', 2, '', 1, 'Andi setiawan', '123', 'wicaksono S.Pd', 'Turi-001/001-Jetis-Ponorogo', 'Ponorogo', 'Ponorogo', '1999-08-07', 20, 'andi@gmail.com', '023105640987', NULL, 'S1 kairo', 'Guru Tafsir hadis, 2th', 'Quran', 'aktif', '', 0, 'BANK BRI SYARIAH (422)', '13213241654654132163'),
('002', 2, '', 1, 'Rian', '12345', 'wijaya', NULL, NULL, NULL, '2001-08-07', NULL, 'rian@gmail.com', '023344456868', NULL, NULL, NULL, 'Matematika', 'aktif', '', 4, '', '6985363610254'),
('003', 3, '', 2, 'Winda', '123456', 'Astuti', NULL, NULL, NULL, NULL, 19, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', '', 3, '', ''),
('004', 3, '', 1, 'Wilda', '1234567', 'Setiawan', 'Karanggebang', NULL, NULL, NULL, 17, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', '', 5, '', ''),
('005', 1, '', 3, 'Arif', '3502092703920001', 'efendi', 'Tempel 001/001, Jetis, Ponorogo', 'Ponorogo', 'Ponorogo', '1992-03-27', 27, 'arifefendi304@gmail.com', '6283845478148', '0055.jpg', 'd2', '3', 'Web Programming ', 'Aktif', '', 0, '', ''),
('006', 3, '', 1, 'Aprillia', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', 0, '', ''),
('RC19000028', 2, '', 1, 'tes', '123455', 'tes', 'tes', 'tes', 'KAB. MADIUN', '2019-10-15', 23, 'tes@gmail.com', '13264654643', NULL, 'tes', NULL, NULL, 'melamar', 'twa', 0, 'BANK BNI (009)', '3216541654654'),
...
--
-- AUTO_INCREMENT for table `app_kritiksaran`
--
ALTER TABLE `app_kritiksaran`
  MODIFY `id_kritiksaran` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `tb_icons`
  MODIFY `idIcons` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `tb_indikator`
--
ALTER TABLE `tb_indikator`
  MODIFY `idIndikator` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tb_kuis`
  MODIFY `id_kuis` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `tb_lombaartikel`
--
ALTER TABLE `tb_lombaartikel`
  MODIFY `idLomba` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
