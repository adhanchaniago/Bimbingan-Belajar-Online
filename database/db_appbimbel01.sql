...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 16, 2019 at 05:32 PM
...
INSERT INTO `app_kritiksaran` (`id_kritiksaran`, `tb_pengguna_penggunaId`, `isikritiksaran`, `status`, `tglinsert`) VALUES
(1, 'RGS19000001', 'tes 1', 'arsip', '2019-09-02 18:39:40'),
(2, 'RGS19000001', 'tes 2', 'Arsip', '2019-09-02 15:44:41');
...
CREATE TABLE `app_kursus` (
  `idapp_kursus` varchar(10) NOT NULL,
  `tb_kategori_kategoriId` int(10) UNSIGNED NOT NULL,
  `tb_bidangStudi_id_bidangStudi` int(10) UNSIGNED NOT NULL,
  ...
  `tempatKursus` varchar(25) DEFAULT NULL,
  `keterangan` varchar(40) DEFAULT NULL,
  `TOTAL_ALPENJUALAN` float NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `app_kursus` (`idapp_kursus`, `tb_kategori_kategoriId`, `tb_bidangStudi_id_bidangStudi`, `tb_jumPertemuan_idjumPertemuan`, `app_users_userid`, `idSiswa`, `tglDaftarKursus`, `tempatKursus`, `keterangan`, `TOTAL_ALPENJUALAN`) VALUES
('0001', 2, 1, 1, '', '001', '0000-00-00 00:00:00', 'ponorogo', 'kursus matematika dasar ', 0),
('0002', 1, 2, 2, '', '001', '0000-00-00 00:00:00', 'ponorogo', 'Kursus Fisika Dasar', 0),
('KB19000003', 0, 1, 0, '', '003', '0000-00-00 00:00:00', NULL, NULL, 0),
('KB19000005', 1, 2, 0, '', '003', '0000-00-00 00:00:00', NULL, NULL, 0),
('KB19000006', 1, 1, 0, '', '004', '0000-00-00 00:00:00', 'ponorogo', 'tes data keterangan', 0),
('KB19000007', 1, 2, 0, '', '004', '0000-00-00 00:00:00', 'wonogiri', 'tes data keterangan kursus', 0),
('KB19000008', 1, 1, 0, '', '001', '0000-00-00 00:00:00', 'pacitan', 'tes keterangan', 0),
('KB19000009', 0, 0, 0, '', 'RGS19000001', '0000-00-00 00:00:00', 'ponorogo', '-', 200000),
('KB19000010', 0, 0, 0, '', 'RGS19000001', '0000-00-00 00:00:00', 'ponorogo', '-', 200000),
('KB19000015', 0, 0, 0, '', 'RG19000002', '2019-09-05 19:00:48', 'PONOROGO', '-', 515000),
('KB19000016', 0, 0, 0, '', 'RG19000004', '2019-09-05 19:06:57', 'PONOROGO', '-', 660000),
('KB19000017', 0, 0, 0, '', 'RG19000004', '2019-09-05 19:11:24', 'po', '-', 780000),
('KB19000019', 0, 0, 0, '', 'RG19000004', '2019-09-05 19:13:58', 'PONOROGO', '-', 420000),
('KB19000020', 0, 0, 0, '', 'RG19000002', '2019-09-05 19:23:40', 'PONOROGO', '-', 250000),
('KB19000021', 0, 0, 0, '', 'RG19000002', '2019-09-05 19:25:03', 'ponorogo', '-', 420000),
('KB19000022', 0, 0, 0, '', 'RG19000004', '2019-09-05 19:43:13', 'ponorogo', '-', 360000),
('KB19000023', 0, 0, 0, '', 'RG19000002', '2019-09-09 03:51:54', 'pacitan', '-', 280000),
('KB19000026', 0, 0, 0, '', 'RG19000004', '2019-09-09 04:17:29', 'pacitan', '-', 240000),
('KB19000027', 0, 0, 0, '', 'RG19000002', '2019-09-09 04:25:17', 'madiun', '-', 350000),
('KB19000028', 0, 0, 0, '', 'RG19000002', '2019-09-09 04:26:50', 'madiun', '-', 300000),
('KB19000029', 0, 0, 0, '', '', '2019-09-10 17:09:44', '', '-', 0);
...
CREATE TABLE `detailjadwal` (
  `idUnix` varchar(20) NOT NULL,
  `idDetailKursus` varchar(20) NOT NULL,
  `jam` time NOT NULL,
...
INSERT INTO `detailjadwal` (`idUnix`, `idDetailKursus`, `jam`, `tglKursus`, `tglinsert`) VALUES
('jhsd78687', '5d715cd208664', '07:00:00', '2019-09-10', '2019-09-19 11:00:00'),
('jshd765sdhj', '5d715cd1ea3a8', '09:00:00', '2019-09-09', '2019-04-27 17:07:34'),
('uisye766765', '5d715cd208664', '04:00:00', '2019-09-10', '2019-09-09 06:00:00');
...
CREATE TABLE `detailkursus` (
  ...
  `KETERANGANTRANSAKSI` varchar(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `detailkursus` (`idUnix`, `subTotal`, `kodeKursus`, `idBidangStudi`, `jumlahSesi`, `perSesi`, `idTentor`, `tglKursus`, `waktuKursus`, `durasiKursus`, `statusKursus`, `pertemuanKe`, `tglSelesai`, `KETERANGANTRANSAKSI`) VALUES
('5d715b6', 240000, 'KB19000015', 2, 4, 60000, '003', '0000-00-00', '', 90, 'aktif', 0, '0000-00-00', ''),
('5d715cd1ea3a8', 275000, 'KB19000016', 4, 5, 55000, '001', '0000-00-00', '', 90, 'aktif', 0, '0000-00-00', ''),
('5d715cd208664', 385000, 'KB19000016', 6, 7, 55000, '', '0000-00-00', '', 0, 'aktif', 0, '0000-00-00', ''),
('5d715ddc3bb96', 420000, 'KB19000017', 5, 7, 60000, '', '0000-00-00', '', 0, 'aktif', 0, '0000-00-00', ''),
('5d715ddc3cb37', 360000, 'KB19000017', 2, 6, 60000, '', '0000-00-00', '', 0, '', 0, '0000-00-00', ''),
('5d715e76f0d71', 420000, 'KB19000019', 2, 7, 60000, '', '0000-00-00', '', 0, 'mendaftar', 0, '0000-00-00', ''),
...
('5d716551acd05', 360000, 'KB19000022', 2, 6, 60000, '', '0000-00-00', '', 0, '', 0, '0000-00-00', ''),
('5d75d25987551', 240000, 'KB19000026', 2, 4, 60000, '', '0000-00-00', '', 0, '', 0, '0000-00-00', ''),
...
INSERT INTO `tb_menu` (`menuid`, `menuparentid`, `menuname`, `menuicon`, `menulink`, `menusort`) VALUES
(1, 0, 'DATA KURSUS', 'mdi mdi-grease-pencil', '#', 0),
(2, 0, 'Kritik&Saran', 'mdi mdi-grease-pencil', '', 0),
(3, 4, 'Data Pengguna', '', 'master/Con_pengguna', 0),
(4, 0, 'Pengguna ', 'mdi mdi-grease-pencil', '', 0),
(6, 0, 'Lomba', 'mdi mdi-grease-pencil', '', 0),
(7, 0, 'Perkembangan', 'mdi mdi-grease-pencil', '', 0),
(8, 0, 'Transaksi', 'mdi mdi-grease-pencil', '', 0),
(9, 6, 'Kuis', '', 'master/Con_kuis', 0),
(10, 6, 'Karya Tulis', '', 'master/Con_karyaTulis', 0),
(11, 7, 'Belajar Siswa', '', 'master/Con_belajarSiswa', 0),
(12, 0, 'Alumni', 'mdi mdi-grease-pencil', '', 0),
(13, 8, 'Transaksi Siswa', '', 'master/Con_transaksiSiswa', 0),
(14, 8, 'Profit Tentor', '', 'master/Con_profitTentor', 0),
(15, 2, 'Pesan', '', 'master/Con_kritikSaran', 0),
(17, 0, 'Setting', 'mdi mdi-grease-pencil', '#', 0),
(19, 17, 'abouts', '', 'master/Con_abouts', 0),
(20, 17, 'Support info', '', 'master/Con_supports', 0),
(21, 1, 'All Jadwal', '', 'master/Con_jadwal', 0),
(22, 4, 'Data User Login', '', 'master/Con_dataUsersLogin', 0),
(23, 12, 'Data alumni', '', 'master/Con_alumni', 0),
(24, 17, 'Set Kuis', '', 'master/Con_setKuis', 0),
(25, 6, 'Riwayat Kuis', '', 'master/Con_Rkuis', 0),
(26, 6, 'Riwayat Karya tulis', '', 'master/Con_RkaryaTulis', 0),
(27, 17, 'Bidang studi', '', 'settings/Con_BidangStudi', 0),
(28, 2, 'Arsip Pesan', '', 'master/Con_arsipPesan', 0),
(29, 1, 'Riwayat Absensi', '', 'master/Con_riwayatAbsensi', 0);
...
('001', 3, '', 2, 'Andi', '123', 'wicaksono', 'Turi-001/001-Jetis-Ponorogo', 'Ponorogo', 'Madiun', '1999-08-07', 20, 'andi@gmail.com', '023105640987', NULL, 'S1 kairo', 'Guru Tafsir hadis, 2th', 'Quran', 'aktif', '', 0),
('002', 2, '', 1, 'Rian', '12345', 'wijaya', NULL, NULL, NULL, '2001-08-07', NULL, 'rian@gmail.com', '023344456868', NULL, NULL, NULL, 'Matematika', 'aktif', '', 0),
('003', 3, '', 2, 'Winda', '123456', 'Astuti', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', '', 0),
('004', 3, '', 1, 'Wilda', '1234567', 'Setiawan', 'Karanggebang', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', '', 0),
...
('RC19000004', 2, '', 1, 'Ardiansah', '3502092703920000', 'Maulana', 'turi 1 - jetis - ponorogo, Surabaya', 'Ponorogo', 'KOTA LHOKSEUMAWE', '1993-09-28', 25, 'arifefendi304@gmail.com', '6283845478148', NULL, 'smk', NULL, NULL, 'melamar', 'mahasiswa', 0),
('RC19000005', 2, '', 1, 'Risa ayu', '3502092703920022', 'astuti', 'madiun', 'madiun', 'KAB. MADIUN', '1999-09-28', 23, 'risa@gmail.com', '0258365245214', NULL, 'smk', NULL, NULL, 'melamar', 'mahasiswi', 0),
('RC19000006', 2, '', 1, 'aldi', '3502092703920023', 'munawir', 'turi', 'ponorogo', 'KAB. MADIUN', '1992-09-27', 23, 'aldi@gmail.com', '082536521452', NULL, 'sma', NULL, NULL, 'melamar', 'mahasiswa', 0),
('RC19000007', 2, '', 1, 'Risa', '', 'Amalia', 'turi 1 - jetis - ponorogo, Surabaya', 'Ponorogo', 'KAB. SIMEULUE', '1998-09-11', 25, 'arifefendi304@gmail.com', '+6282536521452', NULL, 'smk', NULL, NULL, 'melamar', 'mahasiswi', 0),
('RG19000002', 3, '', 1, 'Risa', '56756', 'Amalia', NULL, 'Ponorogo', 'KAB. ACEH TAMIANG', '2019-09-07', 23, 'arifefendi304@gmail.com', '343546576', NULL, 'smp', NULL, NULL, '', 'sma', 0),
('RG19000004', 3, '', 1, 'andi', '321654654', 'saifudin', NULL, 'Ponorogo', 'KAB. PONOROGO', '0000-00-00', 25, 'arifefendi304@gmail.com', '6225402541234', NULL, 'smp', NULL, NULL, '', 'sma', 0);
...
ALTER TABLE `app_kursus`
  ...
  ADD KEY `app_kursus_FKIndex2` (`tb_bidangStudi_id_bidangStudi`),
...
--
ALTER TABLE `tb_bidangstudi`
  MODIFY `id_bidangStudi` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
