<script>
	...
	material.selectdata = function(id) {
		ajaxPost("<?php echo site_url('settings/Con_riwayatPembayaran/getDataSelect') ?>", {id: id}, function (res) {
			material.back(0);
	...
	material.save = function(){
		...
		var url = "<?= base_url('settings/Con_riwayatPembayaran/save') ?>";
		swal({
			...
			if (showLoaderOnConfirm=true) {
				if(material.Mode() === 'Update')
					url = "<?= base_url('settings/Con_riwayatPembayaran/update') ?>";
	...
	material.remove = function(id){
		...
		swal({
			...
			if (isConfirm) {
				ajaxPost("<?php echo base_url('settings/Con_riwayatPembayaran/delete') ?>", {id: id}, function (res) {
					material.back(1);
...
<script>
	$(document).ready(function () {
		...
		material.grid = $("#myTable").DataTable({
			...
			"serverSide": true,
			"ajax": {
				"url": "<?php echo base_url('master/Con_riwayatPembayaran/getData') ?>",
				"type": "POST",
				"data": function(d){ 
