<?php
class Mo_kursusModel extends CI_Model{
	...
	public function insertPembelian($data){
		...
		public function insertKursus($data){
			$query = $this->db->insert('app_kursus', $data); 
			return $query;
		}
	public function insertDetailPembelian($data){
		...
		public function insertDetailKursus($data){
			$query = $this->db->insert('detailKursus', $data); 
			return $query;
		}
